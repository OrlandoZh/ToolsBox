...
| Codex Computer Use 真机桌面验证可选支线 | [CODEX_COMPUTER_USE_VALIDATION.md](./CODEX_COMPUTER_USE_VALIDATION.md) | 只有用户明确要求启动 Computer Use 时才运行 `npm run agent:computer-use:validate -- --user-requested`；默认仍回到 [ZOTERO_TESTING.md](./ZOTERO_TESTING.md) 的主验证链 |

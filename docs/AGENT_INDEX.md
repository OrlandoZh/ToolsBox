...
| Preference Pane / XUL + bridge / host-visible smoke | [PREFERENCE_PANE_GUIDE.md](./PREFERENCE_PANE_GUIDE.md) | 需要看真实踩坑来源时再看 [AIASSISTANT_PITFALLS.md](./AIASSISTANT_PITFALLS.md) |
...
- 当前实现 contract：`UI_CREATION_PATHS.md`、`UI_VALIDATION_PATHS.md`、`ZOTERO_HOST_INTERFACE_CONTRACTS.md`、`ZOTERO_HOST_SEMANTIC_INDEX.md`

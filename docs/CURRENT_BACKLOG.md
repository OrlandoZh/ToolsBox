...
- ToolsBox 产品身份初始化
  - 当前 `addonName=ToolsBox`、`addonRef=toolsbox`、`addonId=toolsbox@orlandozh.github`
  - 当前偏好前缀为 `extensions.zotero.toolsbox`，发布更新入口为 GitHub Releases 的 `release/update.json`
- clean-room 模板骨架
- Zotero 真机开发链
- agent 验证/恢复/汇总/门禁链
- dev-only 性能诊断链

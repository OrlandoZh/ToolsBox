...
const STRINGS = {
  "en-US": {
    ...
    "cleanroom-agent-review-workbench-command-label": "Review Workbench",
    "cleanroom-agent-review-workbench-command-description": "Open the structured review workbench window.",
  ...
  "zh-CN": {
    ...
    "cleanroom-agent-review-workbench-command-label": "审查工作台",
    "cleanroom-agent-review-workbench-command-description": "打开结构化审查工作台窗口。",
  ...
  "zh-TW": {
    ...
    "cleanroom-agent-review-workbench-command-label": "審查工作台",
    "cleanroom-agent-review-workbench-command-description": "開啟結構化審查工作台視窗。",

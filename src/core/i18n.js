...
const STRINGS = {
  "en-US": {
    ...
    "cleanroom-agent-review-workbench-command-label": "Agent Review Workbench",
    "cleanroom-agent-review-workbench-command-description": "Open the dev-only structured review workbench window.",
  ...
  "zh-CN": {
    ...
    "cleanroom-agent-review-workbench-command-label": "Agent Review Workbench",
    "cleanroom-agent-review-workbench-command-description": "打开 dev-only 结构化审查工作台窗口。",
    "cleanroom-reader-toast-title": "Cleanroom Reader",
    ...
    "cleanroom-react-ui-surface-message": "这个条目窗格示例证明：可选 React lane 可以挂载到真实 Zotero 宿主 surface 中，同时继续由 JS core 掌管生命周期与验证证据。",
  ...
  "zh-TW": {
    ...
    "cleanroom-agent-review-workbench-command-label": "Agent Review Workbench",
    "cleanroom-agent-review-workbench-command-description": "開啟 dev-only 結構化審查工作台視窗。",
    "cleanroom-reader-toast-title": "Cleanroom Reader",
    ...
    "cleanroom-react-ui-surface-message": "這個條目窗格示例證明：可選 React lane 可以掛載到真實 Zotero 宿主 surface 中，同時繼續由 JS core 掌管生命週期與驗證證據。",
